...
export const ProfilePage: React.FC = () => {
  ...
  return (
    <div className="w-full min-h-screen max-w-4xl mx-auto px-4 sm:px-6 py-8 md:py-12">
      {/* Profile Header Card */}
      <div className="relative rounded-3xl p-6 sm:p-8 bg-neutral-900/80 border border-neutral-800 shadow-2xl backdrop-blur-xl mb-8 overflow-hidden">
        {/* Subtle Ambient Glow */}
        <div className="absolute -top-24 -right-24 w-72 h-72 rounded-full bg-indigo-600/15 blur-3xl pointer-events-none" />
        ...
        <div className="flex flex-col sm:flex-row items-center sm:items-start gap-6 relative z-10 text-center sm:text-left">
          ...
          {profile.photoURL ? (
            ...
            <div className="w-24 h-24 rounded-3xl bg-gradient-to-tr from-indigo-600 to-purple-600 text-white font-extrabold text-3xl flex items-center justify-center shadow-xl border-2 border-white/10">
          ...
          <div className="flex sm:flex-col gap-2 shrink-0">
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 rounded-xl bg-neutral-800 hover:bg-neutral-750 text-neutral-300 text-xs font-semibold transition-colors"
            >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <Link
          to="/favorites"
          className="group p-6 rounded-3xl bg-neutral-900/60 hover:bg-neutral-900 border border-neutral-800 hover:border-rose-500/40 transition-all shadow-lg flex flex-col justify-between"
        >
        ...
        <Link
          to="/explore"
          className="group p-6 rounded-3xl bg-neutral-900/60 hover:bg-neutral-900 border border-neutral-800 hover:border-indigo-500/40 transition-all shadow-lg flex flex-col justify-between"
        >
          <div className="flex items-center justify-between mb-4">
