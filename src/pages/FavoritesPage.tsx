  ...
  if (!profile) {
    return (
      <div className="min-h-[70vh] flex items-center justify-center px-4">
        <div className="max-w-md w-full text-center p-8 rounded-3xl bg-neutral-900/80 border border-neutral-800 shadow-2xl backdrop-blur-xl">
          ...
          <h2 className="text-2xl font-bold text-white mb-2">Sign In to Save Prompts</h2>
          ...
          <div className="flex flex-col gap-3">
            <Link
              to="/login"
              className="w-full py-3 rounded-2xl bg-gradient-to-r from-indigo-500 to-purple-600 text-white font-bold text-sm shadow-lg shadow-indigo-500/25 hover:opacity-95 transition-all flex items-center justify-center gap-2"
            >
            ...
            <Link
              to="/explore"
              className="w-full py-2.5 rounded-2xl bg-neutral-800 hover:bg-neutral-750 text-neutral-300 font-medium text-xs transition-colors flex items-center justify-center gap-1.5"
            >
